...
(function () {
  ...
  function initIntro() {
    ...
    // Render overview process map and SVG for BOTH conditions
    renderOverviewMap();
    ...
    // Detailed condition: "Begin estimation" button goes to estimation page
  ...
  function renderDetailedEstimation() {
    ...
    content.className = 'detailed-sidebyside-wrapper';
    ...
    let html = `
      <div class="page-card fade-in" style="margin-bottom: 16px;">
        <h1>Estimate the time for each part of the procedure</h1>
        <p>The process map below shows all the steps participants completed. Each lettered zone (<strong>A</strong>, <strong>B</strong>, <strong>C</strong>…) corresponds to an estimation card on the right. Click any step on the map to reveal hidden sub-actions.</p>
    ...
    function positionCards() {
      ...
      const cardLeft = svgRect.right - parentRect.left + 16; // 16px gap from SVG
